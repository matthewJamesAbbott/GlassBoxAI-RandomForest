...
void PrintHelp() {
    cout << "Random Forest CLI Tool (OpenCL)" << endl;
    cout << "Matthew Abbott 2025" << endl;
    cout << endl;
    cout << "Usage: forest_opencl <command> [options]" << endl;
    cout << endl;
    cout << "Commands:" << endl;
    ...
    cout << "  --max-features=N   Maximum features per split (default: sqrt(n))" << endl;
    cout << "  --criterion=C      Split criterion: gini, entropy, mse, variancereduction (default: gini)" << endl;
    cout << "  --task=T           Task type: classification, regression (default: classification)" << endl;
    cout << "  --save=FILE        Save model to file (required)" << endl;
    cout << endl;
    cout << "TRAIN Options:" << endl;
    cout << "  --model=FILE       Model file to load (required)" << endl;
    cout << "  --data=FILE        Training data CSV file (required)" << endl;
    cout << "  --save=FILE        Save trained model to file (required)" << endl;
    cout << endl;
    cout << "PREDICT Options:" << endl;
    cout << "  --model=FILE       Model file to load (required)" << endl;
    cout << "  --data=FILE        Data file for predictions (required)" << endl;
